...
详细说明见 [docs/architecture.md](docs/architecture.md)，信息源清单见 [docs/sources.md](docs/sources.md)，AI 落地步骤见 [docs/ai-playbook.md](docs/ai-playbook.md)，问题与改进记录见 [docs/issues-and-improvements.md](docs/issues-and-improvements.md)。
